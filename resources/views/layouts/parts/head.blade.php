<head>
    ...
    <meta name="description" content="Salingbantu - Crowdfunding sb built with laravel ">
    <meta name="keywords" content="Crowdfunding sb built with laravel">
    ...
    <link rel="stylesheet" href="{{asset('sb/vendor_assets/css/select2.min.css')}}">
    <link rel="stylesheet" href="{{asset('sb/vendor_assets/css/simple-line-icons.css')}}">
