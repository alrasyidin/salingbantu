<footer class="footer-area footer--light">
    ...
    <!-- inject:js-->
    <script src="{{asset('sb/vendor_assets/js/jquery/jquery-1.12.4.min.js')}}"></script>
    ...
    <script src="{{asset('sb/vendor_assets/js/jquery.counterup.min.js')}}"></script>
    <script src="{{asset('sb/vendor_assets/js/jquery.easing1.3.js')}}"></script>
